...
class _ServiceFactory<T extends Object, P1, P2> {
  ...
  final GetItBetterImplementation _getItInstance;
...
class GetItBetterImplementation implements GetIt {
  ...
  T getWithType<T extends Object>({
    String? instanceName,
    dynamic param1,
    dynamic param2,
    Type? type,
  ...
  /// As dispose functions can be async, you should await this function.
  @override
  Future<bool> popScopesTill(String scopeName2) async {
    assert(scopeName2 != _baseScopeName, "You can't pop the base scope");
    if (_scopes.firstWhereOrNull((x) => x.name == scopeName2) == null) {
      return false;
    }
    String? scopeName;
    do {
